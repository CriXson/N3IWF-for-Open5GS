...
func BuildInitialUEMessage(ue *context.N3IWFUe, nasPdu []byte,
	...
	// UserLocationInformation
	{
		...
		*/
		...
		userLocationInfoNR := userLocationInformation.UserLocationInformationNR
		userLocationInfoNR.NRCGI = ngapType.NRCGI{PLMNIdentity: ue.AMF.PLMNSupportList.List[0].PLMNIdentity,
			NRCellIdentity: ngapType.NRCellIdentity{Value: aper.BitString{Bytes: []byte{0, 0, 0, 1, 0}, BitLength: 36}}}
		userLocationInfoNR.TAI = ngapType.TAI{PLMNIdentity: ue.AMF.PLMNSupportList.List[0].PLMNIdentity,
